...
def guessMp3FileName(m4aFileName, alacdir, librarydir):
	...
	mp3FileName = re.sub(r'(\d+ )- (.*)', r'\1\2', mp3FileName)
	mp3FileName = re.sub(r'0*(\d+)\.(\d\d.*)', r'\1-\2', mp3FileName)
	return mp3FileName
...
if __name__ == "__main__":
	...
	alacdir = r'/Users/Scott/Desktop/alac/Albums'
	librarydir = r'/Volumes/Time Machine/iTunes/Music'
	hitlist = []
	misslist = []
	...
	for filename in m4aFiles:
		...
		if os.path.exists(mp3FileName):
			...
			#os.rename(filename, newM4aFileName)
